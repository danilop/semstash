...
flowchart LR
    ...
    style SV fill:#3F8624,stroke:#fff,color:#fff
    style Bedrock fill:#01A88D,stroke:#fff,color:#fff
    style Bedrock2 fill:#01A88D,stroke:#fff,color:#fff
    style F fill:#232F3E,stroke:#fff,color:#fff
    style Q fill:#232F3E,stroke:#fff,color:#fff
    style R fill:#232F3E,stroke:#fff,color:#fff
```
